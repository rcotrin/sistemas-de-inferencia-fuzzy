...
\newcommand{\numberequation}[1]{\addtocounter{equation}{#1}\tag{\theequation}}
    ...
    \begin{abstract}
        ...
        the outputs of the MANDANI model with outputs from a system by Takagi-Sugeno, or the reverse, identifying which were the best outputs looking at the universe of
